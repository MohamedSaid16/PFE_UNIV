...
const ScheduleHearings = () => (
  <ModulePlaceholderPage
    eyebrow="Committee President Workspace"
    title="Schedule Hearings"
    description="The Schedule Hearings module now has a polished dashboard layout and is ready for the next implementation step. Connect the backend workflow and operational actions when this feature's business rules are finalized."
    stats={[
...
export default ScheduleHearings;
