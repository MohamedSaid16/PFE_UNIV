...
const FinalDecisions = () => (
  <ModulePlaceholderPage
    ...
    description="The Final Decisions module now has a polished dashboard layout and is ready for the next implementation step. Connect the backend workflow and operational actions when this feature's business rules are finalized."
    stats={[
