...
// ─── DASHBOARD ────────────────────────────────────────────────────────────────
function Dashboard({ dossiers, conseils, enseignants, etudiants, president, onNav, onViewConseil, onConseilCreated }) {
...
// ─── DOSSIERS LIST ────────────────────────────────────────────────────────────
function DossiersList({ dossiers, conseils, membres, onNav }) {
...
function ConseilsList({ conseils, dossiers, membres, enseignants, etudiants, president, onViewConseil, onConseilCreated }) {
  ...
  // ── Student tree filtered by search ──────────────────────────
  const filteredTree = {};
  const q = etudiantSearch.toLowerCase();
  Object.entries(studentTree).forEach(([fil, specs]) => {
    Object.entries(specs).forEach(([spec, promos]) => {
    ...
    switch (screen) {
      case "dashboard":
        return <Dashboard
          ...
          onConseilCreated={handleConseilCreated}
        />;
      case "dossiers":
        return <DossiersList dossiers={dossiers} conseils={conseils} membres={membres} onNav={setScreen} />;
      case "conseils":
        return <ConseilsList
